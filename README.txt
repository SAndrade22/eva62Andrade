...
a persistence unit "eva62AndradePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Andrade/pom.xml":
...
artifact ("eva62Andrade.war") is already built. You can build
